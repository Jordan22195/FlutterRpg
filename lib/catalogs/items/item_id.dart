...
enum ItemId {
  ...
  MITHRIL_SHIELD(
    EquipmentItemDefinition(
      ...
      value: 120,
      fibLevel: 5,
      statWeights: {SkillId.DEFENCE: 13},
  ...
  STONE_AXE(
    WeaponItemDefinition(
      ...
      value: 10,
      fibLevel: 0,
      statWeights: {SkillId.WOODCUTTING: 1},
      actionInterval: MediumAttackSpeed,
  ...
  COPPER_AXE(
    WeaponItemDefinition(
      ...
      value: 10,
      fibLevel: 1,
      statWeights: {SkillId.WOODCUTTING: 2},
      actionInterval: MediumAttackSpeed,
  ...
  IRON_AXE(
    WeaponItemDefinition(
      ...
      value: 25,
      fibLevel: 2,
      statWeights: {SkillId.WOODCUTTING: 3},
      actionInterval: MediumAttackSpeed,
  ...
  STEEL_AXE(
    WeaponItemDefinition(
      ...
      value: 60,
      fibLevel: 3,
      statWeights: {SkillId.WOODCUTTING: 5},
      actionInterval: MediumAttackSpeed,
  ...
  MITHRIL_AXE(
    WeaponItemDefinition(
      ...
      value: 150,
      fibLevel: 4,
      statWeights: {SkillId.WOODCUTTING: 8},
      actionInterval: MediumAttackSpeed,
  ...
  COPPER_SICKLE(
    WeaponItemDefinition(
      ...
      value: 10,
      fibLevel: 1,
      statWeights: {SkillId.HERBALISM: 2},
      actionInterval: MediumAttackSpeed,
  ...
  IRON_SICKLE(
    WeaponItemDefinition(
      ...
      value: 25,
      fibLevel: 2,
      statWeights: {SkillId.HERBALISM: 3},
      actionInterval: MediumAttackSpeed,
  ...
  STEEL_SICKLE(
    WeaponItemDefinition(
      ...
      value: 60,
      fibLevel: 3,
      statWeights: {SkillId.HERBALISM: 5},
      actionInterval: MediumAttackSpeed,
  ...
  MITHRIL_SICKLE(
    WeaponItemDefinition(
      ...
      value: 150,
      fibLevel: 4,
      statWeights: {SkillId.HERBALISM: 8},
      actionInterval: MediumAttackSpeed,
  ...
  GOBLIN_SCEPTER(
    WeaponItemDefinition(
      ...
      value: 150,
      fibLevel: 5,
      statWeights: {SkillId.ATTACK: 12, SkillId.DEFENCE: 4},
      actionInterval: MediumAttackSpeed,
