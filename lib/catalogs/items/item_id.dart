...
enum ItemId {
  ...
  STEEL_AXE(
    WeaponItemDefinition(
      ...
      name: "Steel Axe",
      value: 60,
      skillBonus: {SkillId.ATTACK: 8, SkillId.WOODCUTTING: 20},
      actionInterval: MediumAttackSpeed,
  ...
  MITHRIL_AXE(
    WeaponItemDefinition(
      ...
      name: "Mithril Axe",
      value: 150,
      skillBonus: {SkillId.ATTACK: 16, SkillId.WOODCUTTING: 40},
      actionInterval: MediumAttackSpeed,
  ...
  STEEL_PICKAXE(
    WeaponItemDefinition(
      ...
      name: "Steel Pickaxe",
      value: 60,
      skillBonus: {SkillId.ATTACK: 8, SkillId.MINING: 20},
      actionInterval: MediumAttackSpeed,
  ...
  MITHRIL_PICKAXE(
    WeaponItemDefinition(
      ...
      value: 150,
      skillBonus: {SkillId.ATTACK: 16, SkillId.MINING: 40},
      actionInterval: MediumAttackSpeed,
  ...
  STEEL_SICKLE(
    WeaponItemDefinition(
      ...
      name: "Steel Sickle",
      value: 60,
      skillBonus: {SkillId.ATTACK: 8, SkillId.HERBALISM: 20},
      actionInterval: MediumAttackSpeed,
  ...
  MITHRIL_SICKLE(
    WeaponItemDefinition(
      ...
      name: "Mithril Sickle",
      value: 150,
      skillBonus: {SkillId.ATTACK: 16, SkillId.HERBALISM: 40},
      actionInterval: MediumAttackSpeed,
