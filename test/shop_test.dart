...
void main() {
  ...
  test(
    'restock fills 10 distinct items and buy price beats sell price',
    () {
      final shop = shopDef(
        EntityId.TRADING_POST,
      ).toEntity(EntityId.TRADING_POST);
  ...
  test(
    'buying deducts coins, grants the item, and depletes stock',
    () {
      final shop = shopDef(
        EntityId.TRADING_POST,
      ).toEntity(EntityId.TRADING_POST);
  ...
  test(
    'shop stock survives a save/load round trip',
    () {
      final shop = shopDef(
        EntityId.TRADING_POST,
      ).toEntity(EntityId.TRADING_POST);
  ...
  test(
    'dev forest builds both shops as permanent entities',
    () {
      ...
      final shops = devForest.permanentEntities
          .whereType<ShopEntity>()
          .toList();
